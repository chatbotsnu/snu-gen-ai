...
Yes, you can stop participating at any time without penalty. If you choose to withdraw, close the window and return your submission on Prolific. Your answers will not be saved if you exit the study early. However, please note that you will not receive payment in this case. 
...
6.	I understand that I can withdraw participation in the study whenever I want without any risk to me. 
    ...
    if consent == "Disagree":
        ...
        st.warning("Thank you for your time. Please close this page and return this submission on Prolific.")
